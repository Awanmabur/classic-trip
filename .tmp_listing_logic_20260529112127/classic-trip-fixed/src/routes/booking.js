...
router.post("/confirm", auth, requireRole("customer", "admin", "super_admin"), ctrl.confirm);
...
// View bookings
router.get("/me", auth, requireRole("customer", "admin", "super_admin"), ctrl.myBookings);
router.get("/guest/:lookupCode", ctrl.guestLookup);

// Cancel (customer/admin)
router.patch("/:id/cancel", auth, requireRole("customer", "admin", "super_admin"), ctrl.cancel);
