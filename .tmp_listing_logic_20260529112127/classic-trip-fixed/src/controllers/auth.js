...
function makePayload(user, sid) {
  return { userId: user._id.toString(), email: user.email, role: user.role, companyId: user.companyId ? user.companyId.toString() : undefined, sid, referralCode: user.referralCode };
}
