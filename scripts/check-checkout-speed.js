...
check('pending Pesapal provider projections are deferred after booking binding is durable', () => assert(booking.includes('Deferred payment projection failed') && booking.includes('await repository.bookings.save(rows.booking')));
