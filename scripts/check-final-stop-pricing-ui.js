...
check('Payment information panel has top margin', (homeCss + publicAdditions).includes('.paymentPage .directInfoHeader,.paymentPage .directTicketPreview{margin-top:16px!important}'));
check('Passenger controls use uniform height', (homeCss + publicAdditions).includes('.directPassengerForm>select[name="sexes"]') && (homeCss + publicAdditions).includes('emergencyContactNames') && (homeCss + publicAdditions).includes('height:44px!important'));
