...
check('rolling queue defers real vehicle overlaps without freezing future repairs', materializer.includes("startsWith('vehicle_schedule_conflict')") && materializer.includes('activePersistentBlocker') && materializer.includes('pending > 0 && created > 0') && materializer.includes('five-minute recovery scan') && !materializer.includes('persistFullWindowVehicleConflictBlocker'));
