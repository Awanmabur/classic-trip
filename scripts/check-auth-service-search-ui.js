...
check('homepage loads the isolated service-search controller before the main homepage controller',
  home.indexOf('/js/home-service-search.js?v=1.6.7') > 0 && home.indexOf('/js/home-service-search.js?v=1.6.7') < home.indexOf('/js/home.js?v=1.6.7'));
...
check('authentication loads its isolated controller', login.includes('/js/auth-page.js?v=1.6.7'));
