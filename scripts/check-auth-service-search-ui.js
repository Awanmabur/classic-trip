...
check('homepage loads the isolated service-search controller before the main homepage controller',
  home.indexOf('/js/home-service-search.js?v=1.4.10') > 0 && home.indexOf('/js/home-service-search.js?v=1.4.10') < home.indexOf('/js/home.js?v=1.4.10'));
...
check('authentication loads its isolated controller', login.includes('/js/auth-page.js?v=1.4.10'));
...
check('inactive authentication panels start hidden', ['signupPanel','supportPanel','forgotPanel','partnerPanel'].every((id) => login.includes(`id="${id}" hidden aria-hidden="true"`)));
