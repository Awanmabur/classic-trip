...
check('version matches current package', Number(String(pkg.version).split('.')[2] || 0) >= 34);
...
if(!process.exitCode) console.log(`Rolling conflict scan checks passed (${passed}/6).`);
