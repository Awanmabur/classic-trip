...
check('Stay Bar image column stretches through the complete row', () => assert(css.includes('v1.6.82: Stay bars must use the same full-height media column') && css.includes('height:auto!important') && css.includes('height:100%!important')));
