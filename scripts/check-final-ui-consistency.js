...
assert(hotel.includes('Stay setup journey') && hotel.includes('hotelSetupStep'), 'Hotel setup must be presented as one ordered journey');
assert(hotel.includes('Public stay listing') && hotel.includes('Property profile') && hotel.includes('Dated inventory'), 'Hotel setup journey must cover listing through dated inventory');
...
assert(hotel.includes('Today’s stay operations') && hotel.includes('Arrivals today') && hotel.includes('In-house stays') && hotel.includes('Departures today') && hotel.includes('Maintenance'), 'Hotel setup and daily operations must be separated');
...
assert(card.includes('marketplaceListingCard') && card.includes('Cheapest route fare') && card.includes('per available night'), 'Shared card must support bus and hotel pricing copy');
