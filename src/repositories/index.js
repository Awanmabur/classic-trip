...
const entityModelMap = {
  ...
  aircraft: 'Aircraft',
  flightSeatMapVersions: 'FlightSeatMapVersion',
  flightRoutes: 'FlightRoute',
  flightFareFamilies: 'FlightFareFamily',
  flightDepartures: 'FlightDeparture',
  flightSeatInventories: 'FlightSeatInventory',
  ...
  flightAgentQuotes: 'FlightAgentQuote',
  flightChangeRequests: 'FlightChangeRequest',
  flightRefundRequests: 'FlightRefundRequest',
  vehicleClasses: 'VehicleClass',
  taxiVehicles: 'TaxiVehicle',
  taxiDriverProfiles: 'TaxiDriverProfile',
  taxiServiceZones: 'TaxiServiceZone',
  taxiFareRules: 'TaxiFareRule',
...
const filterOverrides = {
  ...
  places: (row) => ({ id: row.id }),
  airports: (row) => ({ id: row.id }),
  airlines: (row) => ({ id: row.id }),
  flightSuppliers: (row) => ({ id: row.id }),
  aircraftTypes: (row) => ({ id: row.id }),
  aircraft: (row) => ({ id: row.id }),
  flightSeatMapVersions: (row) => ({ id: row.id }),
  flightRoutes: (row) => ({ id: row.id }),
  flightFareFamilies: (row) => ({ id: row.id }),
  flightDepartures: (row) => ({ id: row.id }),
  flightSeatInventories: (row) => ({ id: row.id }),
  flightOffers: (row) => ({ id: row.id }),
  flightOrders: (row) => ({ id: row.id }),
  flightTravelers: (row) => ({ id: row.id }),
  flightSeatAssignments: (row) => ({ id: row.id }),
  flightTickets: (row) => ({ id: row.id }),
  flightAncillaries: (row) => ({ id: row.id }),
  flightScheduleChanges: (row) => ({ id: row.id }),
  flightAgentQuotes: (row) => ({ id: row.id }),
  flightChangeRequests: (row) => ({ id: row.id }),
  flightRefundRequests: (row) => ({ id: row.id }),
  vehicleClasses: (row) => ({ id: row.id }),
  taxiVehicles: (row) => ({ id: row.id }),
  taxiDriverProfiles: (row) => ({ id: row.id }),
  taxiServiceZones: (row) => ({ id: row.id }),
  taxiFareRules: (row) => ({ id: row.id }),
  driverAvailabilities: (row) => ({ id: row.id }),
  driverLocations: (row) => ({ id: row.id }),
  rideQuotes: (row) => ({ id: row.id }),
  rideRequests: (row) => ({ id: row.id }),
  taxiRides: (row) => ({ id: row.id }),
  rideAssignments: (row) => ({ id: row.id }),
  rideEvents: (row) => ({ id: row.id }),
  taxiIncidents: (row) => ({ id: row.id }),
  driverEarnings: (row) => ({ id: row.id }),
