  ...
  return vehicles
    ...
    .map((vehicle) => {
      ...
      return {
        ...
        numberingStartSide: version?.numberingStartSide || template?.numberingStartSide || vehicle.numberingStartSide || 'left',
        driverPosition: version?.driverPosition || template?.driverPosition || vehicle.driverPosition || 'right',
        frontRowPassengerSeats: Number(version?.frontRowPassengerSeats ?? template?.frontRowPassengerSeats ?? vehicle.frontRowPassengerSeats ?? 0) === 1 ? 1 : 0,
        rowLayoutOverrides: version?.rowLayoutOverrides || template?.rowLayoutOverrides || vehicle.rowLayoutOverrides || [],
