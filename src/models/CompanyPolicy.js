...
const companyPolicySchema = new Schema({
  ...
  policyType: { type: String, default: 'operations', index: true, enum: ['operations', 'hotel', 'bus', 'cancellation', 'refund', 'baggage', 'boarding', 'no_show', 'support', 'check_in', 'check_out', 'housekeeping'] },
