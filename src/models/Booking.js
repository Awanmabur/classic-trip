...
bookingSchema.index({ companyId: 1, scheduleId: 1, createdAt: -1 });
bookingSchema.index({ companyId: 1, 'ticketLegs.scheduleId': 1, createdAt: -1 });
bookingSchema.index({ companyId: 1, 'bookingLegs.scheduleId': 1, createdAt: -1 });
bookingSchema.index({ companyId: 1, 'bookingItems.scheduleId': 1, createdAt: -1 });
