...
const userSchema = new Schema({
  ...
  role: { type: String, enum: ['super_admin', 'admin', 'finance_admin', 'support_admin', 'content_admin', 'company_admin', 'company_employee', 'customer', 'promoter'], default: 'customer', index: true },
