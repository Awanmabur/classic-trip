...
const commissionSchema = new Schema({
  ...
  commercialModel: { type: String, enum: ['percentage_commission','fixed_per_unit','mixed_agreement'], default: 'percentage_commission' },
  ...
  promoterRewardModel: { type: String, enum: ['none','fixed_amount','percentage_of_platform','mixed'], default: 'none' },
