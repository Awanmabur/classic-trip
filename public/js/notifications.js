(function () {
  ...
  function injectStyles() {
    ...
    style.textContent = [
      ...
      '.ctNotifyPanel{position:absolute;right:0;bottom:58px;width:min(380px,calc(100vw - 24px));max-height:min(520px,70vh);overflow:hidden;border:1px solid var(--line,rgba(255,255,255,.14));border-radius:20px;background:var(--panel,var(--card,#0b1220));color:var(--text,#f8fafc);box-shadow:0 20px 60px rgba(0,0,0,.38);display:none}',
      ...
      '.notificationPageList{display:grid;gap:10px;margin-top:12px}.ctNotifyPageItem{display:grid;grid-template-columns:minmax(0,1fr) auto;gap:12px;align-items:start;padding:13px 14px;border:1px solid var(--line,rgba(148,163,184,.18));border-radius:16px;background:var(--field,var(--card,rgba(255,255,255,.04)));color:var(--text,#f8fafc)}.ctNotifyPageItem.is-read{opacity:.72}.ctNotifyPageItem strong{display:block;font-size:13px;margin-bottom:4px}.ctNotifyPageItem p{margin:0;color:var(--muted,#cbd5e1);font-size:12px;line-height:1.5}.ctNotifyPageItem small{display:block;margin-top:7px;color:var(--muted2,#94a3b8);font-size:11px}.ctNotifyPageActions{display:flex;gap:7px;flex-wrap:wrap;justify-content:flex-end}.ctNotifyPageActions button,.ctNotifyPageActions a{min-height:34px;border:1px solid var(--line,rgba(148,163,184,.18));border-radius:11px;padding:7px 10px;background:var(--card,#111827);color:inherit;font:inherit;font-size:11px;font-weight:850;text-decoration:none;cursor:pointer}',
      'html[data-theme="light"] .ctNotifyPanel{background:#fff;color:#0f172a}html[data-theme="light"] .ctNotifyItem,html[data-theme="light"] .ctNotifyHead,html[data-theme="light"] .ctNotifyAction{color:#0f172a}html[data-theme="light"] .ctNotifyItem span,html[data-theme="light"] .ctNotifyItem small,html[data-theme="light"] .ctNotifyStatus{color:rgba(15,23,42,.66)}html[data-theme="light"] .ctNotifyPageItem{background:rgba(15,23,42,.045);color:#0f172a}html[data-theme="light"] .ctNotifyPageItem p,html[data-theme="light"] .ctNotifyPageItem small{color:rgba(15,23,42,.66)}',
