(function () {
  ...
  function injectStyles() {
    ...
    style.textContent = '.ctNotifyDock{position:fixed;right:18px;bottom:18px;z-index:9999;font-family:Inter,Arial,sans-serif}.ctNotifyButton{width:46px;height:46px;border:1px solid var(--line,rgba(255,255,255,.18));border-radius:50%;background:var(--card,#111827);color:var(--text,#fff);box-shadow:0 14px 34px rgba(0,0,0,.3);cursor:pointer;display:grid;place-items:center}.ctNotifyButton:focus{outline:2px solid #4aa3ff;outline-offset:2px}.ctNotifyBadge{position:absolute;top:-5px;right:-5px;min-width:20px;height:20px;border-radius:999px;background:#ef4444;color:#fff;font-size:11px;font-weight:800;display:none;align-items:center;justify-content:center;padding:0 5px}.ctNotifyPanel{position:absolute;right:0;bottom:58px;width:min(360px,calc(100vw - 32px));max-height:460px;overflow:auto;border:1px solid rgba(255,255,255,.14);border-radius:18px;background:var(--panel,#0b1220);color:var(--text,#f8fafc);box-shadow:0 20px 60px rgba(0,0,0,.4);display:none}.ctNotifyPanel.is-open{display:block}.ctNotifyHead{display:flex;align-items:center;justify-content:space-between;gap:10px;padding:12px 14px;border-bottom:1px solid rgba(255,255,255,.1)}.ctNotifyHead strong{font-size:14px}.ctNotifyEnable{border:0;border-radius:6px;background:#2fd17c;color:#06110c;font-weight:800;padding:7px 9px;cursor:pointer}.ctNotifyList{display:grid}.ctNotifyItem{border:0;border-bottom:1px solid rgba(255,255,255,.08);background:transparent;color:inherit;text-align:left;padding:12px 14px;cursor:pointer}.ctNotifyItem:hover{background:rgba(255,255,255,.05)}.ctNotifyItem strong{display:block;font-size:13px;margin-bottom:4px}.ctNotifyItem span{display:block;color:var(--muted,#cbd5e1);font-size:12px;line-height:1.4}.ctNotifyItem small{display:block;color:var(--muted2,#94a3b8);margin-top:6px}.ctNotifyItem.is-read{opacity:.62}.ctNotifyEmpty{padding:16px;color:var(--muted,#cbd5e1);font-size:13px}';
